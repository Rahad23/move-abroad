...
const Advertisement=()=>{
    ...
    return <div className="px-12">
        <div className="lg:h-[274px] bg-white lg:-mt-24 mt-10 rounded-2xl mx-auto lg:grid p-6 lg:border-r-4 border-r-0 flex flex-col lg:flex-row h-full border-[#274396] shadow-lg" style={{gridTemplateColumns:"4fr 2fr"}} >
