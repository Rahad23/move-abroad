...
const Footer=()=>{
  ...
  <div className="footer grid grid-cols-4 h-[513px] gap-x-3 p-10 text-white">
  ...
  <div className="h-[128px] flex items-center flex-col pt-5 px-5">
  ...
  <div className="px-10">
    <hr />
   <div className="flex justify-between items-center mt-3 p-7">
