...
const BannerText=()=>{
    AOS.init(400);
    return  <div className="text-center lg:text-left" data-aos="zoom-in">
    ...
    <div>
    <div className="flex items-center mt-7 justify-center lg:justify-start">
    <div className="flex items-center">
    <input type="email" placeholder="Type here" className="input input-bordered w-full max-w-xs relative pl-9 h-12" required />
    <button className="btn btn-active bg-[#274396] ml-1 lg:ml-3 hover:bg-[#D82027] border-none ">Book now</button>
    </div>
    <button className="absolute p-2 mr-[312px]">
