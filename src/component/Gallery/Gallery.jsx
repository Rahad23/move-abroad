            ...
            <div className='bg-[rgba(54,49,49,.5)] lg:h-full h-[500px]  flex items-center justify-center'>
               <div className='w-[650px]'>
                ...
                <div className="rounded-none w-full h-16 card bg-white  place-items-center border-r-[1px] border-[#ddd] grid px-2 rounded-l-lg py-2" style={{gridTemplateColumns:"30px 4fr"}}>
                    ...
                    <input type="text" placeholder="Country" className="input w-full max-w-xs focus:outline-none border-[1px] border-[rgba(221,221,221,.3)] rounded-[2px]" />
                    </div>
                    ...
                    <input type="text" placeholder="University" className="input w-full max-w-xs focus:outline-none border-[1px] border-[rgba(221,221,221,.3)] rounded-[2px]" />
                    </div>
